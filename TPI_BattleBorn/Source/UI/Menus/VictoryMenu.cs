...
namespace TPI_BattleBorn
{
    public class VictoryMenu : MenuComponent
    {
        ...
        public VictoryMenu(Game game) : base(game, "VictoryMenu", new Vector2(Globals.screenWidth / 2, Globals.screenHeight / 2), new Vector2(Globals.screenWidth, Globals.screenHeight))
        {
